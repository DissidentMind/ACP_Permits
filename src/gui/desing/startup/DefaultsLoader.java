...
public class DefaultsLoader {
    ...
    public static final List<String> DEFAULT_FILE_EXTENSIONS = Arrays.asList(".pdf", ".kmz", ".dwg", ".doc", ".docx", ".xls",".xlsx", ".xlsm", ".ppt", ".pps",
            ".pptx", ".xml", ".csv", ".zip",".7z", ".rar", ".sql", ".mdb", ".email", ".msg",
            ".rtf", ".txt");
